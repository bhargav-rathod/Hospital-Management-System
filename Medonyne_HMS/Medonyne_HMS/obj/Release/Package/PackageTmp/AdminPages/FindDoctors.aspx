<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FindDoctors.aspx.cs" Inherits="Medonyne_HMS.AdminPages.FindDoctors" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Button ID="Button13" runat="server" OnClick="Button13_Click" Text="Show Details" />
            ...
            <tr>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:ListBox ID="ListBox1" runat="server" AutoPostBack="True" CssClass="auto-style10" OnSelectedIndexChanged="ListBox1_SelectedIndexChanged" Width="256px"></asp:ListBox>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
